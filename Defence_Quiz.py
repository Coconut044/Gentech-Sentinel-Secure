...
def generate_quiz_question(difficulty):
    prompt = f"""
    Generate a precise, factual multiple-choice question about defence cybersecurity.
    ...
    {{
        "question": "What is a primary role of cybersecurity in defense systems?",
        "options": [
            "Protecting classified information from unauthorized access",
            "Ensuring physical security of military bases",
            "Enhancing the durability of defense equipment",
            "Training personnel in combat techniques"
        ],
        "correct_answer": 0,
        "explanation": "Cybersecurity in defense focuses on safeguarding classified information and communication systems from cyber threats to maintain national security."
    }}
...
def generate_performance_analysis(score_percentage, missed_topics):
    prompt = f"""
    Provide a professional, technical performance analysis for a defence cybersecurity assessment:
    Performance Data:
...
# Main application
def main():
    st.title("🪖 Defence Cybersecurity Quiz")
