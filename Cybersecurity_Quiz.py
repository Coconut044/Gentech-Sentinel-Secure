...
def generate_quiz_question(difficulty):
    prompt = f"""
    Generate a precise, factual multiple-choice question about cybersecurity.
    ...
    {{
        "question": "What is the primary purpose of implementing a firewall in a cybersecurity framework?",
        "options": [
        ...
        "correct_answer": 0,
        "explanation": "A firewall acts as a barrier between trusted and untrusted networks, monitoring and controlling incoming and outgoing network traffic based on predetermined security rules to prevent unauthorized access."
    }}
...
def generate_performance_analysis(score_percentage, missed_topics):
    prompt = f"""
    Provide a professional, technical performance analysis for a cybersecurity assessment:
    Performance Data:
