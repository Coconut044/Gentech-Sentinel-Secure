...
def generate_quiz_question(difficulty):
    prompt = f"""
    Generate a precise, factual multiple-choice question about transportation cybersecurity.
    ...
    {{
        "question": "What is a key role of cybersecurity in modern transportation systems?",
        "options": [
            "Preventing unauthorized access to traffic control systems",
            "Increasing fuel efficiency of vehicles",
            "Enhancing the speed of public transport",
            "Reducing wear and tear on road infrastructure"
        ],
        "correct_answer": 0,
        "explanation": "Cybersecurity in transportation is crucial for protecting traffic control systems, autonomous vehicles, and transportation networks from cyber attacks, ensuring safety and operational efficiency."
    }}
...
def generate_performance_analysis(score_percentage, missed_topics):
    prompt = f"""
    Provide a professional, technical performance analysis for a transportation cybersecurity assessment:
    Performance Data:
...
# Main application
def main():
    st.title("🛻Transportation Cybersecurity Quiz")
